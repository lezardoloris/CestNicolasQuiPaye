...
export const XP_TABLE: Record<XpActionType, XpActionConfig> = {
  ...
  github_pr_opened: { xp: 25, maxPerDay: 10, label: 'PR GitHub ouverte' },
  github_pr_merged: { xp: 100, maxPerDay: 5, label: 'PR GitHub fusionnée' },
  github_issue_opened: { xp: 15, maxPerDay: 10, label: 'Issue GitHub ouverte' },
